  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const [gradesRes, scheduleRes] = await Promise.all([
        ...
        axios.get(`http://localhost:5000/api/schedule/student/${user?.username}`)
      ]);
      ...
      // 2. TÍNH LỊCH HỌC TRONG TUẦN NÀY
      ...
      const classesInWeek = schedules.filter(item => {
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <ComposedChart data={chartData} margin={{ top: 20, right: 20, bottom: 20, left: 0 }}>
                    ...
                    <Bar 
                      ...
                      fill="#60A5FA" // Xanh dương
                      radius={[4, 4, 0, 0]} 
                      barSize={40}
                    />
                    
                    {/* Đường Điểm TB Tích lũy */}
                    <Line 
                      yAxisId="left" 
                      type="monotone" 
                      dataKey="cumGPA" 
            ...
            <div className="p-3">
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-gray-500">tiết học</span>

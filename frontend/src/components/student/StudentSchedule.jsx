      ...
      <AnimatePresence>
        {tooltipData && viewType === 'week' && !selectedCourse && (
          <motion.div 
            ...
            className="fixed z-40 bg-white/95 backdrop-blur-md text-slate-800 text-sm p-4 rounded-2xl shadow-2xl border border-blue-200/80 pointer-events-none w-[260px]"
